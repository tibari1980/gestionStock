...
public class CommandeClientBean extends AbstractEntity {
	...
	@Builder
	public CommandeClientBean(Instant createdDate, Instant lastUpdateDate, Long code, String codeCommandeClient,
			Instant dateCommande, ClientBean clientBean, Collection<LigneCommandeClientBean> ligneCommandeClientBeans,
